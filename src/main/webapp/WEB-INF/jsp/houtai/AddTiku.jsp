            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			   ...
			   <div class="modal-content">
			          <div class="modal-header">
			            <h5 class="modal-title" id="exampleModalLabel">添加题库</h5>
			          ...
			          <div class="modal-body">
			            <form class="form-horizontal">
			              <div class="form-group">
			                ...
			                <div class="col-sm-10">
			                  <input type="text" class="form-control" id="fileTtle" value="${data.fileTtle }">
			                </div>
			              </div>
			              <div class="form-group">
			                <label for="inputEmail3" class="col-sm-2 control-label">题材说明</label>
			                <div class="col-sm-10">
			                  <input type="text" class="form-control" id="fileDirections" value="${data.fileDirections }">
			                </div>
			              </div>
			              <div class="form-group">
			                <label for="inputEmail3" class="col-sm-2 control-label">题材详情</label>
			                <div class="col-sm-10">
			                  <input type="text" class="form-control" id="fileContent" value="${data.fileContent }">
			                </div>
			              </div>
			              <div class="form-group">
			                <label for="inputEmail3" class="col-sm-2 control-label">题材地址</label>
			                <div class="col-sm-10">
			                  <input type="text" class="form-control" id="fileUrl" value="${data.fileUrl }">
	...
	WebUploader.Uploader.register({
		...
		afterSendFile : function(file) {
			...
			$.ajax({
				...
				success : function(response) { 
					 $("#fileUrl").val(hosturl+"static/File/" + response)  
